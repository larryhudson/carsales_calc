...
if transmission_switch:
	transmission_string = "GenericGearType%3D%5B" + user_transmission
else:
	transmission_string = ""

if price_switch:	
	price_string = "Price%3Drange%5B" + str(price_min) + ".." + str(price_max)
else:
	price_string = ""		
...
driver.get("http://www.carsales.com.au/cars/results?q=%28%28%28%28%28%28%28Make%3D%5B" + user_make + "%5D%26Model%3D%5B" + user_model + "%5D%29%26State%3D%5B" + user_state + "%5D%29%26Service%3D%5BCarsales%5D%29%26" + transmission_string + "%5D%29%26" + price_string + "%5D%29%26Odometer%3Drange%5B" + str(kms_min) + ".." + str(kms_max) + "%5D%29%26%28BodyStyle%3D%5BHatch%5D%7CBodyStyle%3D%5BSedan%5D%29%29&sortby=Year&limit=24")
